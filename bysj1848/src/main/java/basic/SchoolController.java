...
public class SchoolController extends HttpServlet {
    ...
    //     http://localhost:8080/myschool/index.html   前台url
    //   http://49.234.227.112:8080/bysj1836/myschool/index.html
    /**
     * 方法-功能
     * put 修改
     * post 添加
     ...
     */
    //请使用以下JSON测试增加功能
    //{"description":"id为null新学院","no":"0201","remarks":""}

    //请使用以下JSON测试修改功能
    //{"description":"修改id=1的学院","id":1,"no":"0201","remarks":""}
    /**
     * POST,http://localhost:8080/school.ctl
    ...
    /**
     * DELETE, http://localhost:8080/school.ctl?id=1
    ...
    /**
     * PUT, http://localhost:8080/school.ctl
